...
object Constants {
    ...
    val AppSPName = "FunnyTimesProviderPreferences"
    ...
    val ProviderTools = "ProviderTools"
    val LOCATION_UPDATE_INTERVAL = 8000L
    val LOCATION_UPDATE_FASTEST_INTERVAL = 6000L
    val REQUEST_CODE_CHECK_SETTINGS = 15
    val LOCATION_REQUEST_CODE = 997
}