...
class SWithdrawMethodAdapter  (val context: Context, var data: ArrayList<FTPWithdrawMethod>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.SortName.text = data[position].MethodName


        return view
    }

    override fun getItem(position: Int): FTPWithdrawMethod? {
